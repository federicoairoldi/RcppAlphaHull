...
#
# NB: this script compares speed of constructions of the alpha hull complement only, it doesn't consider 
# the time spent to compute the Voronoi tesselation/Delanuay triangulation.
